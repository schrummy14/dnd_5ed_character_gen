...
_highElf = {
    'elfWeaponTraining' : "You have proficiency with the longsword, shortsowrd, shortbow, and longbow.", 
...
_drow = {
    'superiorDarkvision' : "Superior Darkvision: your darkvision has a radius of 120 feet.", 
